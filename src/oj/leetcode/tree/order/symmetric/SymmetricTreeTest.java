...
public class SymmetricTreeTest {
	...
	@Test
	public void test() {
		TreeNode tree = TreeBuilder.buildBinaryTree(new String[] {"1", "2", "2", "3", "4", "4", "3"});
		boolean symmetric = inst.isSymmetric(tree);
		assertTrue(symmetric);
		
		tree = TreeBuilder.buildBinaryTree(new String[] {"1", "2", "2", "#", "4", "4", "#"});
		symmetric = inst.isSymmetric(tree);
		assertTrue(symmetric);
		
		tree = TreeBuilder.buildBinaryTree(new String[] {"1", "2", "2", "3", "#", "#", "3"});
		symmetric = inst.isSymmetric(tree);
		assertTrue(symmetric);
		
		tree = TreeBuilder.buildBinaryTree(new String[] {"1", "2", "2", "3", "4", "4", "#"});
		symmetric = inst.isSymmetric(tree);
